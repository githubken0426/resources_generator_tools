...
public class Gen35ServiceImpl implements GenTask {

	@Override
	public String generate(Param p) throws Exception {
		// 根据 template\ServiceImplTemplate.java中的内容，生成ServiceImpl.java文件

		String src = p.base_dir + SourceGeneratorConst.TEMPLATE_SOURCE_ROOT_PATH
		...
		tar = tar + p.base_name2 + "ServiceImpl.java";
